// server.js - COMPLETE WORKING VERSION WITH REAL-TIME CASE STATUS
...
// Upload treatment plan (Admin) - MOVES TO PENDING APPROVAL
app.put('/api/cases/:id/treatment-plan', async (req, res) => {
    try {
        const { id } = req.params;
        const { files, uploadedBy, notes } = req.body;
